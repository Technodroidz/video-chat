...
<html lang="en">
    ...
    <body>
        ...
        <script src="https://videochat-app.younggeeks.net/video-chat/js/loader.v2.js" data-source_path="https://videochat-app.younggeeks.net/video-chat/" ></script>
    </body>
</html>