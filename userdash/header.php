...
if (isset($_GET['wplogin']) && isset($_GET['url'])) {
    ...
    $actual_link = str_replace('userdash/', '', $actual_link);
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if ($_SESSION["tenant"] == 'user') { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="usershours.php">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="roomsforquiz.php">
                        <i class="fas fa-fw fa-file"></i>
                        <span data-localize="Assigned_quiz">Assigned Quiz</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="visitorquizindex.php">
                        <i class="fas fa-fw fa-file"></i>
                        <span data-localize="quiz_attempt_report">MCQ Quiz Report</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="essaytypequizsuser-answer.php">
                        <i class="fas fa-fw fa-file"></i>
                        <span data-localize="quiz_attempt_report">Essay Type Quiz Report</span></a>
                </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="user.php?id=<?php echo $_SESSION["agent"]["user_id"]; ?>">
