        ...
        <div class="col-md-offset-2 col-md-8">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="question_text" name="question_text" placeholder="Enter the question text here" readonly ></textarea>
                </div>
                <div class="form-group">
                    <label for="quiz_answer">Answer</label>
                    <textarea class="form-control" id="quiz_answer" name="quiz_answer" readonly></textarea>
                </div>
                <div class="form-group">
