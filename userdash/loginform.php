...
<html lang="en">
    ...
    <head>
        ...
        <title>CLE User Dashboard</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post">
                                            <center>
                                                <span><h5>Please Enter User Credentials.</h5></span>
                                            </center><br>
                                            <div class="form-group">
                                                <input type1="text" class="form-control" id="username" aria-describedby="emailHelp" placeholder="Username">
        ...
        <script>
            $('#loginbutton').click(function (event) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {type: 'login', email: $("#username").val(), password: $("#password").val()},
                    success: function (data) {
                        if (data) {
                            if(data == 'blocked'){ 
                                $("#error").show();
                                $("#error").html("This user is blocked, please unblock the user first !");
                            }else{
