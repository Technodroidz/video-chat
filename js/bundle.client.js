...
function showFullScreen() {
    ...
    else e = document.getElementById("video_container");
...
function stopFullScreen() {
    $("#fullScreen").show(), document.fullscreen && document.exitFullscreen ? document.exitFullscreen() : document.fullscreen && document.msExitFullscreen ? document.msExitFullscreen() : document.fullscreen && document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.fullscreen && document.webkitCancelFullScreen && document.webkitCancelFullScreen(), document.getElementById("exitFullscreenButton") && (document.getElementById("exitFullscreenButton").style.display = "none")
}
...
var prevId, prevMsgP, prevBody, estimateDif = function (e) {
        var n = parseInt(e / 1e3, 10),
            t = Math.floor(n / 3600),
    ...
    generateLink = function (e) {
        ...
        if ($("#duration").val() || $("#durationtext").val()) {
            var o = $("#durationtext").val() ? $("#durationtext").val() : $("#duration").val();
            n.duration = o
        }
        $("#disableVideo").is(":checked") && (n.disableVideo = 1), $("#disableAudio").is(":checked") && (n.disableAudio = 1), $("#disableScreenShare").is(":checked") && (n.disableScreenShare = 1), $("#disableWhiteboard").is(":checked") && (n.disableWhiteboard = 1), $("#disableTransfer").is(":checked") && (n.disableTransfer = 1), $("#autoAcceptVideo").is(":checked") && (n.autoAcceptVideo = 1), $("#autoAcceptAudio").is(":checked") && (n.autoAcceptAudio = 1);
        var i = "";
        e && (i = "&broadcast=1");
        var r = window.btoa(unescape(encodeURIComponent(JSON.stringify(n))));
        r = r.split("=").join(""), visitorUrl = lsRepUrl + "pages/" + roomLinkPage + "?room=" + sessionId + "&p=" + r + i, viewerBroadcastLink = lsRepUrl + "pages/" + roomLinkPage + "?room=" + sessionId + "&p=" + r + i + "&broadcast=1";
        var a = document.createElement("input");
        a.setAttribute("value", visitorUrl), document.body.appendChild(a), a.select(), document.execCommand("copy"), document.body.removeChild(a), $("#roomPass").val() && (n.pass = $("#roomPass").val()), delete n.visitorName, n.isAdmin = 1, r = (r = window.btoa(unescape(encodeURIComponent(JSON.stringify(n))))).split("=").join(""), agentUrl = lsRepUrl + "pages/" + roomLinkPage + "?room=" + sessionId + "&p=" + r + "&isAdmin=1" + i, agentBroadcastUrl = lsRepUrl + "pages/" + roomLinkPage + "?room=" + sessionId + "&p=" + r + "&isAdmin=1" + i + "&broadcast=1"
    },
    ...
    getPrettyDate = function (e) {
        var n = new Date,
            ...
            r = new Date(1e3 * e),
            a = r.getFullYear(),
            s = ("0" + (r.getMonth() + 1)).slice(-2),
            d = ("0" + r.getDate()).slice(-2),
            c = ("0" + r.getHours()).slice(-2),
            l = ("0" + r.getMinutes()).slice(-2);
...
var errorTimer, incomingAudio, incomingMessage, enterRoom, showMessage = function (e, n, t, o, i, r) {
        if (n) {
            n = linkify(n);
            ...
            if (t = "" !== t && null !== t && "undefined" !== t && void 0 !== t ? t : "" === e ? "" : a, "conference" == conferenceStyle) {
                ...
                if (o = o || "", prevId && e == prevId) u = prevMsgP, d = prevBody;
                else {
                    if ((u = $("<div />", {
                            class: className
                        })).attr("data-system-attribue", o), e && "Me" !== e) {
                        var s = $("<h6 />", {});
                ...
                var c;
                (c = $("<p />")).html(n), c.appendTo(d), (c = $("<p />", {
                    class: "meta"
                })).html('<time datetime="2018">' + t + "</time>"), c.appendTo(d), u.appendTo($("#chat-content")), $("#typing").html(""), prevId = e, prevMsgP = u, prevBody = d, (l = document.getElementById("chat-content")).scrollTop = 999999
            } else {
                var l, u = document.createElement("li"),
                    m = "left",
                    g = "",
                    f = "";
                if ("Me" === e || "Me~" == e.substring(0, 3)) {
                    ...
                    if ("Me~" == e.substring(0, 3))
                        if (e = e.substring(3, 300), v = " right-image", "img/small-avatar.jpg" !== i && i) f = '<img class="direct-chat-img ' + m + '" src="' + i + '" alt="" />';
                        else f = (f = e.match(/\b(\w)/g).join("").toUpperCase()) ? '<span class="acronym-right">' + f + "</span>" : '<img class="direct-chat-img ' + m + '" src="img/small-avatar.jpg" alt="" />';
                    e = smartVideoLocale.msgStore.me, className = "wd-right-bubble" + v
                } else if ("" === e) {
                    var p = "";
                    "divider" === o && (p = " divider"), className = "wd-system-bubble" + p
                } else if (playIncomingMessage(), "undefined" === e && (e = "Guest"), g = "wd-chat-name", "wd-chat-avatar", className = "wd-left-bubble", i || (i = "/img/small-avatar.jpg"), f = '<img class="direct-chat-img ' + m + " " + guestName(e) + '" src="' + i + '" alt="" />', "He~" == e.substring(0, 3))
                    if (e = e.substring(3, 500), "/img/small-avatar.jpg" !== i && i) f = '<img class="direct-chat-img ' + m + " " + guestName(e) + '" src="' + i + '" alt="" />';
                    else {
    ...
    saveChat = function (e, n, t, o, i, r) {
        var a = queryString.names ? queryString.names : svConfigs.agentName,
...
function hark(e, n) {
    var t = window.webkitAudioContext || window.AudioContext,
        o = this;
        ...
        a = o.WordArray = r.extend({
            ...
            concat: function (e) {
                ...
                if (e = e.sigBytes, this.clamp(), o % 4)
                    for (var i = 0; i < e; i++) n[o + i >>> 2] |= (t[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 24 - (o + i) % 4 * 8;
                else if (65535 < t.length)
                    for (i = 0; i < e; i += 4) n[o + i >>> 2] = t[i >>> 2];
...
! function () {
    ...
    e.enc.Base64 = {
        stringify: function (e) {
            ...
            e.clamp(), e = [];
            for (var i = 0; i < t; i += 3)
                for (var r = (n[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (n[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | n[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, a = 0; 4 > a && i + .75 * a < t; a++) e.push(o.charAt(r >>> 6 * (3 - a) & 63));
            if (n = o.charAt(64))
            ...
            for (var i = [], r = 0, a = 0; a < t; a++)
                if (a % 4) {
                    var s = o.indexOf(e.charAt(a - 1)) << a % 4 * 2,
                        d = o.indexOf(e.charAt(a)) >>> 6 - a % 4 * 2;
    ...
    d = d.MD5 = s.extend({
        ...
        _doProcessBlock: function (e, r) {
            ...
            var d = e[r + 0],
                ...
                b = e[r + 14],
                _ = e[r + 15],
                I = n(I = a[0], A = a[1], E = a[2], k = a[3], d, 7, c[0]),
                k = n(k, I, A, E, s, 12, c[1]),
                E = n(E, k, I, A, l, 17, c[2]),
                A = n(A, E, k, I, u, 22, c[3]);
...
function () {
    ...
    n.EvpKDF = function (e, n, t) {
        ...
        l.Encryptor = l.extend({
            ...
            reset: function () {
                ...
                var e = (n = this.cfg).iv,
                    n = n.mode;
                if (this._xformMode == this._ENC_XFORM_MODE) var t = n.createEncryptor;
                else t = n.createDecryptor, this._minBufferSize = 1;
        ...
        var u = n.CipherParams = t.extend({
            ...
            g = (g.kdf = {}).OpenSSL = {
                execute: function (e, n, t, i) {
                    return i || (i = o.random(8)), e = a.create({
                        keySize: n + t
                    }).compute(e, i), t = o.create(e.words.slice(n), 4 * t), e.sigBytes = 4 * n, u.create({
                        key: e,
                        iv: t,
                        salt: i
                    })
    ...
    function () {
        ...
        t = t.AES = n.extend({
            _doReset: function () {
                for (var e = (t = this._key).words, n = t.sigBytes / 4, t = 4 * ((this._nRounds = n + 6) + 1), i = this._keySchedule = [], r = 0; r < t; r++)
                    if (r < n) i[r] = e[r];
                    else {
                        var a = i[r - 1];
...
var RTCMultiConnection = function (e, n) {
    ...
    function o(e, n) {
        ...
        function r(n, t) {
            e.peersBackup[n] || (e.peersBackup[n] = {
                userid: n,
                extra: {}
            }), e.peersBackup[n].extra = t
        }
        e.socket.on("extra-data-updated", function (n, t) {
            e.peers[n] && (e.peers[n].extra = t, e.onExtraDataUpdated({
                userid: n,
                extra: t
            }), r(n, t))
        }), e.socket.on(e.socketMessageEvent, function n(o) {
            if (o.remoteUserId == e.userid)
                if (e.peers[o.sender] && e.peers[o.sender].extra != o.message.extra && (e.peers[o.sender].extra = o.extra, e.onExtraDataUpdated({
                        userid: o.sender,
                        extra: o.extra
                ...
                else if (o.message.newParticipationRequest && o.sender !== e.userid) {
        ...
        e.socket.resetProps = function () {
            ...
            e.leave(), e.onEntireSessionClosed({
                sessionid: n,
                userid: n,
                extra: t
            })
    ...
    function i(e) {
        var n = this,
            t = ["getAllParticipants", "getLength", "selectFirst", "streams", "send", "forEach"];
        ...
        e.peers = {
        ...
        }, this.onNegotiationNeeded = function (e, n) {}, this.addNegotiatedMessage = function (t, o) {
        ...
        }, this.onGettingRemoteMedia = function (e, n) {}, this.onRemovingRemoteMedia = function (e, n) {}, this.onGettingLocalMedia = function (e) {}, this.onLocalMediaError = function (n, t) {
            e.onMediaError(n, t)
            ...
            o(), e.fbr.readAsArrayBuffer(n, function (n) {
                ...
                userid: e.userid,
                chunkSize: "Firefox" === DetectRTC.browser.name ? 15e3 : e.chunkSize || 0
            })
        };
        var i = new x(e);
        ...
        }, this.onNegotiationStarted = function (e, n) {}, this.onNegotiationCompleted = function (e, n) {}, this.getRemoteStreams = function (n) {
    ...
    function m(e) {
        return void 0 === e
            ...
            return e
        }, document.addEventListener = document.removeEventListener = t.addEventListener = t.removeEventListener = function () {}, t.HTMLVideoElement = t.HTMLMediaElement = function () {}), "undefined" == typeof io && (t.io = function () {
            return {
                on: function (e, n) {
                    n = n || function () {}, "connect" === e && n()
                },
                emit: function (e, n, t) {
                    t = t || function () {}, "open-room" !== e && "join-room" !== e || t(!0, n.sessionid, null)
                }
            }
        ...
        function () {
            ...
            var o = !!/Android|webOS|iPhone|iPad|iPod|BB10|BlackBerry|IEMobile|Opera Mini|Mobile|mobile/i.test(t.userAgent || ""),
                ...
                r = !!window.opera || t.userAgent.indexOf(" OPR/") >= 0,
                a = void 0 !== window.InstallTrigger,
                s = /^((?!chrome|android).)*safari/i.test(t.userAgent),
                d = !!window.chrome && !r,
            ...
            var w = /^(192\.168\.|169\.254\.|10\.|172\.(1[6-9]|2\d|3[01]))/,
                y = /([0-9]{1,3}(\.[0-9]{1,3}){3})/,
            ...
            function O(e) {
                if (R)
                    if (!t.enumerateDevices && window.MediaStreamTrack && window.MediaStreamTrack.getSources && (t.enumerateDevices = window.MediaStreamTrack.getSources.bind(window.MediaStreamTrack)), !t.enumerateDevices && t.enumerateDevices && (t.enumerateDevices = t.enumerateDevices.bind(t)), t.enumerateDevices) {
                        I = [], k = [], E = [], A = [], T = !1, x = !1, M = !1, P = !1, V = !1;
                        var n = {};
            ...
            L.browser = function () {
                    t.appVersion;
                    var e, n, o, l = t.userAgent,
                        u = t.appName,
                        m = "" + parseFloat(t.appVersion),
            ...
            L.displayResolution = H, L.displayAspectRatio = (q = screen.width, Q = screen.height, W = function e(n, t) {
                ...
                if (L.isWebRTCSupported) {
                    ...
                    ! function (e, n) {
                        ...
                        if (!o) return;
                        var a = null;
                        "Chrome" === L.browser && L.browser.version < 58 && (a = {
                            optional: [{
                                RtpDataChannels: !0
                            }]
                        });
                        var s = svConfigs.iceServers,
                            d = new o(s, a);
                ...
                O(e = e || function () {})
            }, L.MediaDevices = void 0 !== I ? I : [], L.hasMicrophone = T, L.hasSpeakers = x, L.hasWebcam = M, L.isWebsiteHasWebcamPermissions = V, L.isWebsiteHasMicrophonePermissions = P, L.audioInputDevices = k, L.audioOutputDevices = E, L.videoInputDevices = A;
            var z = !1;
    ...
    var y = window.RTCSessionDescription || window.mozRTCSessionDescription,
        b = window.RTCIceCandidate || window.mozRTCIceCandidate,
        _ = window.MediaStreamTrack;
    ...
    function I(e) {
        ...
        if (n.attachStreams.forEach(function (e) {
            ...
            try {
                var d = {
                    ...
                    iceTransportPolicy: n.iceTransportPolicy || s
                };
        ...
        var c = {
            OfferToReceiveAudio: !!a.length,
            OfferToReceiveVideo: !!a.length
        };
        e.localPeerSdpConstraints && (c = e.localPeerSdpConstraints), C.sdpConstraints = w(c);
        var l = {};
        o.ontrack = function (n) {
            if (n && "track" === n.type)
                if (n.stream = n.streams[n.streams.length - 1], n.stream.id || (n.stream.id = n.track.id), l[n.stream.id] && "Safari" !== DetectRTC.browser.name) n.track && (n.track.onended = function () {
        ...
        this.addRemoteCandidate = function (e) {
            ...
            t = t || function () {}, "Safari" !== DetectRTC.browser.name && (e.sdp = n.processSdp(e.sdp)), o.setRemoteDescription(new y(e)).then(t, function (n) {
    ...
    var k = function () {
        ...
        function n(e, n, t, o) {
            ...
            var r = t.videoCodecNumbersOriginal.split("SAVPF")[0] + "SAVPF ",
                a = [i];
        ...
        function o(e, n, t) {
            return function (e, n, t, o, i) {
                for (var r = -1 !== t ? t : e.length, a = n; a < r; ++a)
                    if (0 === e[a].indexOf(o) && (!i || -1 !== e[a].toLowerCase().indexOf(i.toLowerCase()))) return a;
                return null
            }(e, 0, -1, n, t)
        }

        function i(e) {
            var n = new RegExp("a=rtpmap:(\\d+) \\w+\\/\\d+"),
                t = e.match(n);
        ...
        return {
            ...
            prioritize: function (e, n) {
                if (n && n.getSenders && n.getSenders().length) {
                    ...
                    n.getSenders().forEach(function (n) {
                        for (var t = n.getParameters(), o = 0; o < t.codecs.length; o++)
                            if (t.codecs[o].mimeType == e) {
            ...
            forceStereoAudio: function (e) {
                for (var n = e.split("\r\n"), t = null, o = 0; o < n.length; o++)
                    if (-1 !== n[o].search("opus/48000")) {
                        var i = extractSdp(n[o], /:(\d+) opus\/48000/i);
                        break
                    } for (o = 0; o < n.length; o++) {
                    if (-1 !== n[o].search("a=fmtp"))
                        if (extractSdp(n[o], /a=fmtp:(\d+)/) === i) {
                            t = o;
                            break
                        }
                }
                    ...
                    for (var t = svConfigs.iceServers.iceServers, o = 0; o < t.length; o++) {
                        if (t[o].username) {
                            var i = '{"ct":"' + t[o].username + '","iv":"09644439296d0d45c81236b5643e9662","s":"3132333435363738"}',
                                r = JSON.parse(CryptoJS.AES.decrypt(i, svConfigs.iceServers.passPhrase, {
                                    format: n
                        ...
                        if (t[o].credential) {
                            ...
                            var a = JSON.parse(CryptoJS.AES.decrypt(i, svConfigs.iceServers.passPhrase, {
                                format: n
                            }).toString(CryptoJS.enc.Utf8));
                            t[o].credential = a
                        }
    ...
    function R(e) {
        if (!0 !== currentUserMediaRequest.mutex) {
            ...
            if (currentUserMediaRequest.streams[n]) r(currentUserMediaRequest.streams[n].stream, !0);
            else {
        ...
        function r(t, o) {
            ...
            }, !1), currentUserMediaRequest.streams[n] = {
                stream: t
            }, currentUserMediaRequest.mutex = !1, currentUserMediaRequest.queueRequests.length && R(currentUserMediaRequest.queueRequests.shift()), e.onGettingLocalMedia(t, o)
        }
    }
            ...
            receive: function (t, o, i) {
                ...
                if (n[r] || (n[r] = []), n[r].push(t.message), t.last) {
                    ...
                    var s = {
                        ...
                        userid: o,
                        extra: i,
                        latency: (new Date).getTime() - t.sendingTime
                    };
    ...
    ! function (t) {
        n = n || {
            useDefaultDevices: !0
        }, t.channel = t.sessionid = (e || location.href.replace(/\/|:|#|\?|\$|\^|%|\.|`|~|!|\+|@|\[|\||]|\|*. /g, "").split("\n").join("").split("\r").join("")) + "";
        var r = new i(t),
            l = {};

        function m(e) {
            if (t.socketAutoReConnect = !0, t.socket) e && e(t.socket);
            else {
                if (void 0 === o)
        ...
        function w() {
            try {
                return t.streamEvents.selectAll("local").map(function (e) {
                    return {
                        streamid: e.streamid,
                        tracks: e.stream.getTracks().length
                    }
                })
            } catch (e) {
                return []
        ...
        function y(e, n) {
            if (t.dontCaptureUserMedia || e.isDataOnly) n();
            else {
                var o = {};
                ...
                i.oneway && "two-way" !== i.audio && "two-way" !== i.video && "two-way" !== i.screen ? n() : (i.oneway && i.audio && "two-way" === i.audio && (i = {
                    audio: !0
                }), (i.audio || i.video || i.screen) && (i.screen ? "Edge" === DetectRTC.browser.name ? navigator.getDisplayMedia({
                    video: !0,
                    audio: f(t)
                }).then(function (e) {
        ...
        r.onGettingLocalMedia = function (e, n) {
            if (n = n || function () {}, l[e.streamid]) n();
            else {
                l[e.streamid] = !0;
                try {
                    e.type = "local"
            ...
            o = o || function () {};
            var i = {
                remoteUserId: n = n || e.remoteUserId,
                message: e = e || "",
                sender: t.userid
            };
            ...
            t.socket && t.socket.emit("disconnect-with", e, n || function () {}), t.deletePeer(e)
        }, t.socketOptions = {
            transport: "polling"
        }, t.openOrJoin = function (e, n) {
            n = n || function () {}, t.checkPresence(e, function (e, o) {
                if (e) {
                    t.sessionid = o;
                    var i, r, a = !!t.session.oneway,
                        s = u(t.session);
                    r = {
            ...
            n = n || function () {}, t.waitingForLocalMedia = !0, t.isInitiator = !0, t.sessionid = e || t.sessionid, m(function () {
            ...
            if (e && t.peers[e]) {
                var n = {
                    userid: e,
                    extra: t.peers[e] ? t.peers[e].extra : {}
                };
            ...
            t.dontCaptureUserMedia || u(o) ? e() : (o.audio || o.video || o.screen) && (o.screen ? "Edge" === DetectRTC.browser.name ? navigator.getDisplayMedia({
                ...
                if (i.isScreen = !0, r.onGettingLocalMedia(i), !o.audio && !o.video || f(t)) e(i);
                else {
                    var a = {};
            ...
            t.closeBeforeUnload && (t.peers.getAllParticipants().forEach(function (e) {
                r.onNegotiationNeeded({
                    userLeft: !0
                }, e), t.peers[e] && t.peers[e].peer && t.peers[e].peer.close(), delete t.peers[e]
            ...
            n = n || function () {}, t.userid = e || s(), t.socket.emit("changed-uuid", t.userid, n)
        }, t.extra = {}, t.attachStreams = [], t.session = {
            audio: !0,
            video: !0
        }, t.enableFileSharing = !1, t.bandwidth = {
            screen: !1,
            audio: !1,
            video: !1
        }, t.codecs = {
            ...
            audio: {
                mandatory: {},
                optional: t.bandwidth.audio ? [{
                    bandwidth: 8 * t.bandwidth.audio * 1024 || 1048576
                }] : []
            },
            video: {
                mandatory: {},
                optional: t.bandwidth.video ? [{
                    bandwidth: 8 * t.bandwidth.video * 1024 || 1048576
                }, {
                    facingMode: "user"
                }] : [{
                    facingMode: "user"
            ...
            if (DetectRTC.MediaDevices.forEach(function (o) {
                ...
                if ("Firefox" === DetectRTC.browser.name) return void(!0 !== t.mediaConstraints.audio ? t.mediaConstraints.audio.deviceId = e.id : t.mediaConstraints.audio = {
                    deviceId: e.id
                });
            ...
            if (n) {
                if ("Firefox" === DetectRTC.browser.name) return void(!0 !== t.mediaConstraints.video ? t.mediaConstraints.video.deviceId = n.id : t.mediaConstraints.video = {
                    deviceId: n.id
                });
            ...
            mandatory: {}
        }, t.iceServers = A.getIceServers(t), t.candidates = {
            host: !0,
            stun: !0,
            turn: !0
        }, t.iceProtocols = {
            ...
            e = e || function () {}, t.socket.emit("close-entire-session", function n() {
            ...
            void 0 === o ? setTimeout(function () {
                e.mediaElement.play()
            }, 2e3) : o.catch(function () {}).then(function () {
                setTimeout(function () {
                    e.mediaElement.play()
                }, 2e3)
            })
            ...
            o || (o = t.session), e || (e = t.mediaConstraints), R({
                ...
                localMediaConstraints: e || {
                    audio: !!o.audio && e.audio,
                    video: !!o.video && e.video
                }
            })
            ...
            if (e = e || {}, S.prototype.getSenders)
                if (e instanceof _) I(e, n, o);
                else {
        ...
        }, t.autoCloseEntireSession = !1, t.filesContainer = t.videosContainer = document.body || document.documentElement, t.isInitiator = !1, t.shareFile = r.shareFile, void 0 !== P && P.handle(t), void 0 !== V && V.handle(t), t.token = s, t.onNewParticipant = function (e, n) {
        ...
        }, void 0 !== T && (t.StreamsHandler = T), t.onleave = function (e) {}, t.invokeSelectFileDialog = function (e) {
            ...
            return !e && t.enableLogs && console.warn("getSocket.callback paramter is required."), e = e || function () {}, t.socket ? e(t.socket) : m(function () {
                e(t.socket)
            }), t.socket
        ...
        t.getExtraData = function (e, n) {
            ...
            n = n || function () {}, t.socket ? t.socket.emit("set-password", e, n) : (t.password = e, n(!0, t.sessionid, null))
    ...
    function () {
        function e() {
            function e(e, n) {
                ...
                var i, r = 0,
                    a = o,
                    s = Math.floor(Math.min(1e8, a) / o) * o,
                    d = Math.ceil(t.size / o);
                t.maxChunks = d;
                var c = 0,
                    l = [];
                n({
            ...
            this.readAsArrayBuffer = function (n, t) {
                ...
                function i(e) {
                    n.chunks[e.uuid] || (n.chunks[e.uuid] = {
                        currentPosition: -1
                    }), t.extra = t.extra || {
                        userid: 0
                    }, e.userid = t.userid || t.extra.userid || 0, e.extra = t.extra, n.chunks[e.uuid][e.currentPosition] = e, e.end && o && (o(e.uuid), o = null), e.maxChunks > 200 && 200 == e.currentPosition && o && (o(e.uuid), o = null)
                }
        ...
        var o = Uint8Array.BYTES_PER_ELEMENT,
            ...
            d = function (e) {
                var n = 0,
                    t = 0,
                    d = 0,
                    c = new ArrayBuffer(e[0].byte_length + e[0].header_size),
                    l = new DataView(c);
            ...
            c = function (e, n) {
                ...
                var f = s[t],
                    v = null === f ? 0 : window[f + "Array"].BYTES_PER_ELEMENT;
                switch (t) {
                    case a.NULL:
                    case a.UNDEFINED:
                        0, u = null;
            ...
            u = function (e, n) {
                ...
                switch (d = function (e) {
                    var n = void 0;
                    if (void 0 === e) n = a.UNDEFINED;
                    else if (null === e) n = a.NULL;
                    else {
                        var t = e.constructor.name,
                            o = e.constructor.toString().match(/\w+/g)[1];
                        if (void 0 !== t && void 0 !== a[t.toUpperCase()]) n = a[t.toUpperCase()];
                        else if (void 0 !== o && void 0 !== a[o.toUpperCase()]) n = a[o.toUpperCase()];
        ...
        window.FileConverter = t, window.FileSelector = function () {
            ...
            function t(t, o, i) {
                ...
                r.type = "file", o && (r.multiple = !0), i && (r.webkitdirectory = !0), r.accept = e.accept, r.onclick = function () {
                    ...
                    }, r.style.display = "none", (document.body || document.documentElement).appendChild(r),
                    function (e) {
...
var publicRoomIdentifier, connection, videoConnection, screenConnection, tenant, role, sessionId, sessionForChat, roomId, socket, streamConstraints, recentFile, conversationPanel, tempStream, lsDesigner, conferenceStyle, classVideo, videoElementContainer, videoWidgetContainer, roomLinkPage, facingMode, iphoneLocalStream, localVideoStream, caller_name, caller_phone, caller_avatar, caller_email, peer_name, peer_phone, peer_avatar, peer_logo, peer_background, peer_email, lsRepUrl, ui_handler, notify_handler, jQEngager, pluginInstalled, pluginController, comm_controller, visitors, queryString, videoDevices, multiStreamRecorder, agentId, recordScreen, recordCamera, recordingTimer, videoDefault, videoCurrent, audioSource, videoSource, testAudioTrack, testVideoTrack, videoSelect, audioInputSelect, audioOutputSelect, sourceBuffer, passRoom, agentAvatar, visitorName, agentName, datetime, duration, token, room, disableVideo, disableAudio, disableScreenShare, disableWhiteboard, disableTransfer, autoAcceptVideo, autoAcceptAudio, translator, roomPrd, forceClose = !1,
    ...
    comController = function () {
        ...
        this.init = function (t, o) {
            ...
            if (connection.extra = {
                    ...
                    if (svConfigs.videoScreen.enableLogs && console.log("onUserStatusChanged", n), "offline" == n.status && 0 == connection.getAllParticipants().length) {
                        var t = jQEngager.Event("AdminPopupOffline");
                        jQEngager(document).trigger(t), e.handleCallTermination()
                    }
                    "online" == n.status && "admin" === role && socket.emit(connection.socketCustomEvent, {
                        type: "adminOnline",
                        role: "admin"
                    })
                    ...
                    videoConnection.extra.broadcaster = !1, videoConnection.dontCaptureUserMedia = !0, videoConnection.session.oneway = !0,
                        function e() {
                    ...
                    screenConnection.openOrJoin(roomId + "_screen", function (t, o, i) {
                        screenConnection.isInitiator = e, (e || screenConnection.extra.sessionId !== n) && (screenConnection.extra = {
                            sessionId: n
                        }), e && socket.emit(connection.socketCustomEvent, {
                    ...
                    if (!0 !== n.data.typing)
                        ...
                        if ("voiceSpeaking" === n.data) {
                            d = jQEngager.Event("VoiceSpeaking", {
                                id: n.userid
                            });
                            jQEngager(document).trigger(d)
                        }
                        if ("voiceSilence" === n.data) {
                            d = jQEngager.Event("VoiceSilence", {
                                id: n.userid
                            });
                            jQEngager(document).trigger(d)
                        }
                        if (lsDesigner && "plz-sync-points" === n.data) lsDesigner.sync();
                        else if (n.data.whiteboardData) {
                            ...
                            if (jQEngager(document).trigger(d), queryString.isAdmin || localStorage.getItem("hasPrivileges") || e.startWhiteboard(), lsDesigner || e.startWhiteboard(), n.data.whiteboardData) {
                                var a = n.data.whiteboardData,
                                    s = screen.width / n.data.width;
                                a.points.forEach(function (e) {
                                    if ("text" == e[0]) {
                                        e[1][1] = e[1][1] * s, e[1][2] = e[1][2] * s;
                                        var n = e[2][7].split(" "),
                                            t = n[0].split("px");
                                        e[2][7] = t[0] * s + "px " + n[1]
                                    } else "image" == e[0] || "pdf" == e[0] ? (e[1][1] = e[1][1] * s, e[1][2] = e[1][2] * s, e[1][3] = e[1][3] * s, e[1][4] = e[1][4] * s) : (e[1][0] = e[1][0] * s, e[1][1] = e[1][1] * s, e[1][2] = e[1][2] * s, e[1][3] = e[1][3] * s, e[2][0] = e[2][0] * s)
                                }), lsDesigner.syncData(a)
                            } else lsDesigner.clearCanvas()
                        }
                    } else {
                        var d = jQEngager.Event("SendTyping", {
                            typing: !1
                        });
                        jQEngager(document).trigger(d)
                    } else {
                ...
                (videoConnection = new RTCMultiConnection).enableLogs = !!svConfigs.videoScreen.enableLogs && svConfigs.videoScreen.enableLogs, videoConnection.iceServers = svConfigs.iceServers.iceServers, videoConnection.socketURL = svConfigs.appWss, videoConnection.maxParticipantsAllowed = svConfigs.maxParticipantsAllowed ? svConfigs.maxParticipantsAllowed : 1e3, videoConnection.publicRoomIdentifier = publicRoomIdentifier, queryString.broadcast ? videoConnection.sdpConstraints.mandatory = {
                    ...
                    sessionId: sessionId
                }, videoConnection.onclose = videoConnection.onerror = videoConnection.onleave = function (e) {
                    if (e.extra && e.extra.sessionId) {
                        var n = jQEngager.Event("PopupLeft", {
                            sessionId: e.extra.sessionId,
                            isAdmin: 0
                        });
                        jQEngager(document).trigger(n)
                    }
                }, videoConnection.onPeerStateChanged = function (e) {}, videoConnection.onspeaking = function (n) {
                ...
                }, connection.chunkSize = 16e3, connection.enableFileSharing = !0, connection.onUserIdAlreadyTaken = function (e, n) {}, connection.autoSaveToDisk = !1;
                var a = {};
                if (connection.onFileProgress = function (e, n) {
                        ...
                        if (e.userid === connection.userid) {
                            if (!recentFile.started) {
                                ...
                                var n = jQEngager.Event("IncomingFileTransfer", {
                                    name: e.name,
                                    sender: !0,
                                    fileId: e.uuid
                                });
                            ...
                            n = jQEngager.Event("IncomingFileTransfer", {
                                name: e.name,
                                sender: !1,
                                fileId: e.uuid
                            });
                        ...
                        a[e.uuid] = {
                            progress: jQEngager("#progress" + e.uuid)
                        }, a[e.uuid].progress.max = e.maxChunks
                    }, connection.onFileEnd = function (n) {
                        var t = e.getFileHTML(n);
                        if (n.userid === connection.userid)
                            if (recentFile) {
                            ...
                            } else recentFile = null;
                        else jQEngager("#download" + n.uuid).html(t)
                        ...
                        if (svConfigs.videoScreen.enableLogs && console.log("videoConnection.onstream", t), videoConnection.videosContainer = document.getElementById(videoElementContainer), "local" === t.type) {
                            ...
                            if (jQEngager(document).trigger(o), t.stream.isVideo) iphoneLocalStream = RMCMediaTrack.cameraStream = t.stream, RMCMediaTrack.cameraTrack = e.getTracks(t.stream, "video")[0], isiPhone && e.checkMediaDevices(), (r = document.getElementById("localVideo")).setAttribute("data-sessionId", t.extra.sessionId), r.setAttribute("volume", 0), r.setAttribute("autoplay", ""), r.setAttribute("muted", ""), r.setAttribute("playsinline", ""), svConfigs.videoScreen.localFeedMirrored && (r.style.transform = "scale(-1, 1)"), r.srcObject = svConfigs.videoScreen.videoFileStream ? localVideoStream : t.stream, RMCMediaTrack.selfVideo = r, void 0 !== (l = r.play()) && l.then(function () {
                                r.play()
                            }).catch(function (e) {
                                console.log(e)
                        ...
                        if (queryString.broadcast)
                            if ("remote" === t.type && videoConnection.isInitiator) {
                                var u = [];
                                videoConnection.getAllParticipants().forEach(function (e) {
                                    u.push({
                                        pid: e,
                                        broadcaster: !0 === videoConnection.peers[e].extra.broadcaster
                                    })
                        ...
                        if (n.extra) {
                            ...
                            t && (t.parentNode.removeChild(t), $("#remoteVideoSpan" + n.extra.sessionId).remove(), $("#" + n.extra.sessionId).remove());
                        ...
                        videoConnection && (videoConnection.leave(), videoConnection.streamEvents.selectAll({
                            local: !0
                        }).forEach(function (e) {
                    ...
                    screenConnection.mediaConstraints = s, screenConnection.session = {
                        ...
                        if ("local" === e.type) var n = document.getElementById("localScreen");
                        else n = document.getElementById("remoteScreen");
                        try {
            ...
            this.updateListOfRooms = function (n) {
                ...
                n.forEach(function (n, o) {
                    n.participants.forEach(function (o, i) {
                        ...
                        if (r) {
                            var a = r.extra,
                                s = jQEngager("#visitors").find("#" + a.sessionId),
                                d = a.ua ? detect.parse(a.ua) : "",
                                c = d ? d.browser.name : "",
                                l = d ? d.os.name : "",
                            ...
                            if (0 == s.length) {
                                ...
                                f.className = "row msg_container base_receive", f.id = a.sessionId, f.innerHTML = '<div class="col-sm-10 col-xs-10">                                                                        <div class="messages msg_receive">                                                                                <p>' + u + " " + a.referrer + " " + m + "<br/>" + l + " " + c + "</p>                                                                                                                                                        </div>                                                                </div>", jQEngager("#visitors").append(f), t++
                            }
                            if ($("#chat" + a.sessionId).off("click"), $("#chat" + a.sessionId).click(function () {
                                ...
                                $("#form" + a.sessionId).submit(function (n) {
                                    ...
                                    e && JSON.parse(e).forEach(function (e) {
                                        ...
                                        if (e.from == n) var t = "Me",
                                            o = "right";
                                        else t = e.from, o = "left";
                            ...
                            if ("popup" == n.extra.role) {
                                var p = jQEngager("#visitors").find("#" + a.sessionId),
                                    h = jQEngager("#visitors").find("#room" + a.sessionId),
                                    S = !1;
                                if (jQEngager("#roomid_" + n.extra.roomId).html(n.extra.roomId + ' <img src="../img/online.png" alt="waiting to connect">'), n.participants.forEach(function (e, t) {
                                        ...
                                        var e = p.children().children().children(),
                                            t = {};
                                    ...
                                    playEnterRoom();
                                    var C = jQEngager.Event("EnterPageNotification", {
                                        name: u
                                    });
                ...
                socket.on("connect", function (n) {
                    ...
                    if ("initCall" === n.type && sessionId !== n.sessionId && n.roomId === roomId) {
                        ...
                        var t = jQEngager.Event("IncomingCall", {
                    ...
                    if ("customerHere" === n.type && sessionId !== n.sessionId && "dashboard" === roomId) {
                        ...
                        t = jQEngager.Event("EnterCustomerNotification", {
                            name: n.name,
                            roomId: n.roomId
                        });
                    ...
                    if ("customerOut" === n.type && sessionId !== n.sessionId && "dashboard" === roomId && jQEngager("#roomid_" + n.roomId).html(n.roomId), "endCall" === n.type && sessionId !== n.sessionId && n.roomId === roomId && setTimeout(function () {
                        ...
                        t = jQEngager.Event("RemoteVideoUnmuted", {
                            sessionId: n.sessionId
                        });
                        jQEngager(document).trigger(t)
                    }
                    if ("startScreenShare" === n.type && n.roomId === roomId)
                        if (queryString.broadcast) {
                            t = jQEngager.Event("VoiceSpeaking", {
                                id: n.sessionId
                            });
                            jQEngager(document).trigger(t)
                    ...
                    if ("endMeeting" === n.type && n.roomId === roomId) {
                        t = jQEngager.Event("EndMeeting", {
                            sessionId: n.sessionId
                        });
                        jQEngager(document).trigger(t)
                    }
                    if ("adminOnline" === n.type && (n.roomId === roomId || "admin" == n.role)) {
                    ...
                    if ("clearCanvas" === n.type && sessionId !== n.sessionId && n.roomId === roomId && lsDesigner && lsDesigner.clearCanvas(), "sendCallerBack" === n.type && n.roomId === roomId) {
                        t = jQEngager.Event("SendCallerBack", {
                            access: n.access,
                            sessionId: n.sessionId
                        });
                        jQEngager(document).trigger(t)
                    ...
                    if (n.participants && videoConnection && !videoConnection.isInitiator && !videoConnection.extra.broadcaster && n.roomId == roomId && n.participants.forEach(function (e) {
                        ...
                        videoConnection.getAllParticipants().forEach(function (e) {
                            ...
                            participants: i
                        }), toggleError(smartVideoLocale.msgStore.broadcastViewers + " " + i.length, 5e3), $("#wd-widget-content-whiteboard").is(":visible") && lsDesigner && lsDesigner.sync()
                    }
            ...
            facingMode = "user" === facingMode ? "environment" : "user", navigator.mediaDevices.getUserMedia({
                ...
                ! function (e, n) {
                    ...
                    videoConnection.getAllParticipants().forEach(function (n) {
                        ...
                        if (t.getSenders) {
                            var o = e.clone().getVideoTracks()[0],
                                i = e.clone().getAudioTracks()[0];
            ...
            var d = n || ("initVideo" === this.id ? "Video" : "Audio"),
                c = r ? {
                    deviceId: {
                        exact: r
                    }
            ...
            switch (a && jQEngager.extend(!0, l, a), d) {
                case "Video":
                    ...
                    break;
                case "Audio":
                    u = !1, streamConstraints = {
                        audio: c,
                        video: !1
                    };
                    break;
                default:
                    u = !0, streamConstraints = {
                        video: l,
                        audio: c
                    }
            }
            if (queryString.broadcast) {
                var m = function () {
                    queryString.isAdmin && svConfigs.videoScreen.videoFileStream ? (videoConnection.dontCaptureUserMedia = !0, videoConnection.attachStreams = [localVideoStream], videoConnection.extra.broadcaster = !0, videoConnection.openOrJoin(roomId + "_video", function (e, n, t) {
                        if (t) console.error("openOrJoin", t, n);
                        else {
                            var o = jQEngager.Event("LocalVideoStarted");
                            jQEngager(document).trigger(o)
                        }
                ...
                videoConnection.DetectRTC.load(function () {
                    ...
                    if (videoConnection.DetectRTC.videoInputDevices) {
                        o = jQEngager.Event("MediaDevices", {
                            devices: n
                        });
                        jQEngager(document).trigger(o)
                    }
                    streamConstraints.video = !!video_on && streamConstraints.video, streamConstraints.audio = !!audio_on && streamConstraints.audio, videoConnection.mediaConstraints = streamConstraints, videoConnection.session = {
                        video: !!video_on && u,
                        audio: audio_on
            ...
            }), 1 == n && (videoConnection.mediaConstraints.audio = !0, videoConnection.addStream({
                audio: !0
            }));
            var t = e ? "AudioUnmuted" : "AudioMuted",
                o = e ? "remoteAudioUnmuted" : "remoteAudioMuted",
                i = jQEngager.Event(t);
            ...
            }), 1 == n && (videoConnection.mediaConstraints.video = !0, videoConnection.addStream({
                video: !0
            }), videoConnection.session.oneway = !1);
            var t = e ? "VideoUnmuted" : "VideoMuted",
                o = e ? "remoteVideoUnmuted" : "remoteVideoMuted",
                i = jQEngager.Event(t);
            jQEngager(document).trigger(i), socket.emit(connection.socketCustomEvent, {
                type: o,
                role: role,
            ...
            videoConnection.streamEvents.selectAll({
                ...
                if (t) console.error("openOrJoin", t, n);
                else if (!videoConnection.isInitiator) {
            ...
            if (a && jQEngager.extend(!0, s, a), n) var d = o ? {
                deviceId: {
                    exact: o
                }
            } : {
            ...
            r && jQEngager.extend(!0, d, r), streamConstraints = {
                video: d,
                audio: s
            }, videoConnection.session = {
                video: n,
            ...
            videoConnection.streamEvents.selectAll({
                ...
                video: {
                    facingMode: facingMode = "user" === facingMode ? "environment" : "user"
                },
                audio: audio_on
            }, videoConnection.mediaConstraints = streamConstraints, videoConnection.session = {
                video: video_on,
            ...
            var n = function () {
                videoConnection.getAllParticipants().forEach(function (e) {
                    ...
                    o.getSenders && (videoConnection.streamEvents.selectAll({
                        local: !0
                    }).forEach(function (e) {
            ...
            videoConnection && "conference" != conferenceStyle && (videoConnection.streamEvents.selectAll({
                local: !0
            }).forEach(function (n) {
            ...
            videoConnection.DetectRTC.load(function () {
                ...
                var n = jQEngager.Event("MediaDevices", {
                    devices: e
                });
                jQEngager(document).trigger(n)
            })
            ...
            screenConnection && screenConnection.checkPresence(roomId + "_screen", function (e, n, t) {
                setTimeout(function () {
                    screenConnection.isInitiator = !1, screenConnection.extra.sessionId !== sessionId && (screenConnection.extra = {
                        sessionId: sessionId
                    }), e && screenConnection.join(roomId + "_screen", function (e, n, t) {
            ...
            if (svConfigs.videoScreen.screenConstraint) var n = svConfigs.videoScreen.screenConstraint;
            else n = {
                mandatory: {
                    maxWidth: screen.width > 1920 ? screen.width : 1920,
                    maxHeight: screen.height > 1080 ? screen.height : 1080
        ...
        this.getScreenStream = function (t) {
            e.screenHelper(function (o) {
                RMCMediaTrack.screen = e.getTracks(o, "video")[0], RMCMediaTrack.selfVideo.srcObject = o,
                    function e() {
        ...
        }, this.stopRecording = function () {}, this.getSessionId = function () {
            return sessionId
            ...
            socket.emit(connection.socketCustomEvent, {
                ...
                roomId: roomId,
                msg: n
            }), videoConnection && (videoConnection.streamEvents.selectAll({
                local: !0
            }).forEach(function (n) {
                n.stream.isAudio && (n.stream.getAudioTracks()[0] && n.stream.getAudioTracks()[0].stop(), e.getTracks(n.stream, "audio").forEach(function (e) {
                    n.stream.removeTrack(e)
                })), n.stream.isVideo && (n.stream.getVideoTracks()[0] && n.stream.getVideoTracks()[0].stop(), e.getTracks(n.stream, "video").forEach(function (e) {
                    n.stream.removeTrack(e)
                }))
            ...
            if (queryString.broadcast || !svConfigs.videoScreen.separateScreenShare) {
                ...
                screenConnection && screenConnection.streamEvents.selectAll({
                    local: !0
                }).forEach(function (e) {
                    e.stream.getVideoTracks()[0].stop()
                }), screenConnection.attachStreams.forEach(function (e) {
                    e.stop()
                }), screenConnection.isInitiator = !1, screenConnection.extra = {
                    sessionId: null
            ...
            jQEngager("#statusbar").html(e), jQEngager("#statusbar").show(), "Connected to the chat server!" == e ? jQEngager("#statusIcon").html('<i class="fas fa-fw fa-check-circle" id="statusOk"></i>') : jQEngager("#statusIcon").html('<i class="fas fa-fw fa-times-circle" id="statusNotOk"></i>'), setTimeout(function () {
    ...
    uiHandler = function () {
        ...
        this.init = function (t, o, i) {
            ...
            window.resizeTo(window.screen.availWidth, window.screen.availHeight), stopIncomingCall(), t.syncVideoChatPanelsPos(), e("#mainleft_div").show(), "simple" == conferenceStyle && svConfigs.videoScreen && !0 === svConfigs.videoScreen.chat ? (e(".wd-chat-box").show(), e(".wd-chat-box").css("width", "30%"), e(".wd-video-box").css("width", "70%"), e(".wd-video-box").css("border-right", 0), e(".wd-v-text").hide()) : (e(".wd-chat-box").hide(), e(".wd-video-box").css("width", "100%"), e(".wd-video-box").css("border-right", 0), e(".wd-v-text").show()), e("#wd-widget-content-whiteboard").show(), e("#wd-widget-content-chat-main").hide(), e("#wd-widget-content-video").hide(), e("#wd-avatar-agent").hide(), e("#video_container_chat").hide(), queryString.isAdmin || localStorage.getItem("hasPrivileges") ? (e(".wd-v-tovideo").show(), e("#cleanCanvas").show(), e("#whiteboard_canvas iframe").contents().find("#tool-box").show()) : e("#whiteboard_canvas iframe").contents().find("#tool-box").hide(), e("." + classVideo).each(function () {
                var n = this.id;
            ...
            "list" == currentView ? n ? i() : r() : n ? r() : i(), $("video").off("click"), $("video").on("click", function () {
                var n = $(this).attr("class");
                if ("sourcevideo" == n) {
                    var i = e.Event("VoiceSpeaking", {
                        id: this.id
                    });
                    e(document).trigger(i)
                } else if ("bigvideogrid bigvideoadd" == n) {
                    o = !0, r();
                    i = e.Event("VoiceSpeaking", {
                        id: this.id
                    });
                    e(document).trigger(i)
                } else "bigvideo bigvideoadd" == n && (o ? t.changeView(!0) : t.makeAllSmall())
    ...
    notifyHandler = function () {
        ...
        this.init = function () {
            ...
            if (!document.hasFocus()) {
                var t = n.name ? n.name : "Visitor",
                    o = smartVideoLocale.msgStore.incomingText;
                o = o.replace("{{caller_name}}", t), e.showNotification(o)
            }
        }), jQEngager(document).on("EnterCustomerNotification", function (n) {
            if (!document.hasFocus()) {
                var t = n.name ? n.name : "Visitor",
                    o = smartVideoLocale.msgStore.userWaitingRoom;
    ...
    main = function () {
        ...
        jQuery(document).ready(function (n) {
            ...
            }).fail(function () {}), (isiPhone || isAndroid) && (svConfigs.videoScreen.chat = !1), svConfigs.videoScreen && !0 === svConfigs.videoScreen.chat && (widgetSize.width = 1052);
            var o = n("<div>", {
            ...
            var i = function (e) {
                    if (names[e.sessionId] || (names[e.sessionId] = {}), e.callerInfo.name && names[e.sessionId] && names[e.sessionId].name !== e.callerInfo.name) {
                        ...
                        names[e.sessionId] = {
                            ...
                            }, t && (names[e.sessionId].username = t), e.callerInfo.isAdmin && agentName && (names[e.sessionId].name = agentName), n("#peer_name_chat").text(names[e.sessionId].name),
                            function (e) {
                    ...
                    if ("conference" == conferenceStyle) {
                        ...
                        for (var t in names) {
                            ...
                            var i = "",
                                a = "",
                                s = "",
                                d = n("ul#attendeesList");
                            if ("undefined" !== names[t].muted)
                                if (1 == names[t].muted) i = '<i class="fa fa-microphone-slash"></i> ', a = "";
                                else if (a = "", i = '<i class="fa fa-microphone"></i> ', t !== comm_controller.getSessionId()) a = '<span class="user-action"><a data-typeid="' + t + '" href="#" id="muteAttendee' + t + '"><i class="fa fa-fw fa-volume-off"></i> ' + smartVideoLocale.msgStore.mute + "</a></span>";
                            else a = '<span class="user-action"><a data-typeid="' + t + '" href="#" id="muteAllAttendee"><i class="fa fa-fw fa-volume-off"></i> ' + smartVideoLocale.msgStore.muteAll + "</a></span>";
                            if ("undefined" !== names[t].muted && names[t].video && (s = '<i class="fa fa-tv"></i> '), t !== comm_controller.getSessionId()) var c = ' <span class="user-action"><a data-typeid="' + t + '" href="#" id="private' + t + '"><i class="fa fa-comment"></i> ' + smartVideoLocale.msgStore.privateChat + "</a></span>";
                            else c = "";
                            if (queryString.isAdmin) {
                                var l = blockIcon = "";
                                if (queryString.broadcast)
                                    if (names[t].priv) l = ' <span class="user-action"><a data-typeid="' + t + '" href="#" id="revoke' + t + '"><i class="fa fa-stop-circle-o"></i> ' + (f = smartVideoLocale.msgStore.revoke) + "</a></span>";
                                    else names[t].raiseHand && (l = ' <span class="user-action"><a data-typeid="' + t + '" href="#" id="grant' + t + '"><i class="fa fa-hand-paper-o"></i> ' + (f = smartVideoLocale.msgStore.grant) + "</a></span>");
                                ...
                                n("<li>" + i + s + '<span class="mx-10">' + names[t].name + o + "</span>" + a + c + l + blockIcon + "</li>").appendTo(d), n("#grant" + t).on("click", function (e) {
                                    ...
                                    if (1 == confirm(smartVideoLocale.msgStore.sureBlock)) {
                                        ...
                                        }).done(function (e) {}).fail(function () {}), delete names[n(this).attr("data-typeid")], comm_controller.blockUser(n(this).attr("data-typeid")), r(), setTimeout(function () {
                            ...
                            if (t !== comm_controller.getSessionId()) {
                                ...
                                if (n("<a/>").addClass("ui-all").attr("typeid", t).text(names[t].name).attr("title", smartVideoLocale.msgStore.sendMessageTo + names[t].name).appendTo(g).click(function () {
                                    ...
                                    if (names[t].priv) var f = smartVideoLocale.msgStore.revoke,
                                        v = lsRepUrl + "img/revoke.png";
                                    else names[t].raiseHand ? (f = smartVideoLocale.msgStore.grant, v = lsRepUrl + "img/grant.png") : f = "";
                                ...
                                if (queryString.isAdmin && (svConfigs.serverSide.loginForm || svConfigs.serverSide.token)) {
                                    ...
                                    n("<img/>").addClass("centerImg").attr("typeid", t).attr("title", u + " " + names[t].name).attr("src", lsRepUrl + "img/block.png").appendTo(g).click(function () {
                                        1 == confirm(smartVideoLocale.msgStore.sureBlock) && (n.ajax({
                                            ...
                                            data: {
                                                type: "blockuser",
                                                username: names[n(this).attr("typeid")].username
                                            }
                                        }).done(function (e) {
                                            console.log("blocked")
                                        }).fail(function () {}), delete names[n(this).attr("typeid")], comm_controller.blockUser(n(this).attr("typeid")), r(), setTimeout(function () {
                                            ui_handler.toggleVisitors(!1), r()
                                        }, 500))
                                    })
                                }
            ...
            function s(e) {
                ! function (e, n) {
                    ...
                    t = {
                        video: !0
                    }, navigator.mediaDevices.getDisplayMedia ? navigator.mediaDevices.getDisplayMedia(t).then(e).catch(n) : navigator.getDisplayMedia(t).then(e).catch(n)
                }(function (n) {
                    ! function (e, n) {
                        e.addEventListener("ended", function () {
                            n(), n = function () {}
                    ...
                    console.error(e), console.log("Unable to capture your screen. Please check console logs.\n" + e);// old message
                    console.error(e), alert("Your recording is cancel, Please try again.");
                })
            }
            ...
            var c = function () {
                ...
                u = function () {
                    if (!is_chat_opened && (is_chat_opened = !0, svConfigs.serverSide.chatHistory)) {
                        if (queryString.isAdmin)
                            for (var e in names) e !== comm_controller.getSessionId() && (t = e);
                        else var t = comm_controller.getSessionId();
                        n.ajax({
                            type: "POST",
                            url: lsRepUrl + "server/script.php",
                            data: {
                            ...
                            e && JSON.parse(e).forEach(function (e) {
                                var n = svConfigs.agentName ? svConfigs.agentName : "Agent";
                                if (names[comm_controller.getSessionId()] && (e.from == names[comm_controller.getSessionId()].name || queryString.isAdmin && e.from == n)) var t = "Me";
                                else t = e.from;
                ...
                g = function (e) {
                    if (startedRecroding) {
                        ...
                        if (svConfigs.recording.saveServer) {
                            var o = "record_" + room + "_" + getCurrentDateFormatted() + ".webm",
                                i = new FormData;
                            i.append("video-filename", o), i.append("video-blob", multiStreamRecorder.getBlob()), i.append("room", room), i.append("agentName", agentName), i.append("agentId", agentId), i.append("isFfmpeg", 1 == svConfigs.recording.transcode),
                                function (n, t) {
                ...
                v = function () {
                    ...
                    "undefined" == typeof Promise || navigator.mediaDevices.getUserMedia(r).then(a).then(function () {
                        ...
                        if ("NotReadableError" === n.name && audio_on) audio_on = !1;
                        else {
                        ...
                        t = o, void 0 !== (n = e).sinkId ? n.setSinkId(t).then(function () {}).catch(function (e) {
                            var n = e;
                ...
                h = function (e, t) {
                    if (isOnline)
                        if (x(comm_controller.getSessionId(), video_on), queryString.broadcast || !svConfigs.videoScreen.greenRoom || getCookie("lsvGreenRoom")) {
                            ui_handler.restoreVideoBox(), ui_handler.toggleInstaVideo(!1);
                ...
                b = function () {
                    if (queryString.broadcast || !svConfigs.videoScreen.separateScreenShare)
                        if (audio_on) ui_handler.restoreVideoBox(), comm_controller.startScreenShare(), w(!0);
                        else {
                            audio_on = !audio_on;
                ...
                I = function () {
                    ...
                    if (t.setMinutes(t.getMinutes() + parseInt(duration)), e > new Date(datetime) && t > e) {
                        if (svConfigs.videoScreen.exitMeetingOnTime) {
                            var o = new Date,
                                i = t - o,
                                r = t - o - 6e4;
                            console.log(i, r), setTimeout(function () {
                                var e = smartVideoLocale.msgStore.meetingIsToEnd;
                                toggleError(e, 6e4)
                            }, r), setTimeout(function () {
                                n("#end_meeting").trigger("click")
                            }, i)
                        }
                        return !0
                    }
                    var a = new Date,
                        s = new Date(datetime),
                        d = Math.abs(s - a) / 1e3,
                        c = Math.floor(d / 86400);
                    d -= 86400 * c;
                    var l = Math.floor(d / 3600) % 24;
                    d -= 3600 * l;
                    var u = Math.floor(d / 60) % 60;
                    if (d -= 60 * u, diffString = "", c > 0) {
                        var m = c > 1 ? smartVideoLocale.msgStore.days : smartVideoLocale.msgStore.day;
                        diffString = c + " " + m
                    }
                    if (0 === c && l > 0) {
                        var g = l > 1 ? smartVideoLocale.msgStore.hours : smartVideoLocale.msgStore.hour;
                        diffString = l + " " + g
                    }
                    if (0 === c && 0 == l && u > 0 && (diffString = u + " " + smartVideoLocale.msgStore.minutes), 0 === c && 0 == l && 0 == u && (diffString = smartVideoLocale.msgStore.seconds), diffString && new Date(datetime) > e) {
                        var f = smartVideoLocale.msgStore.notexactAppointment,
                            v = getPrettyDate(new Date(datetime).getTime() / 1e3),
                            p = (p = f.replace("{{timemeeting}}", v)).replace("{{diffString}}", diffString);
                        toggleNotification(p, !0);
                        var h = new Date,
                            S = new Date(datetime) - h;
                        setTimeout(function () {
                ...
                A = function () {
                    if (names[comm_controller.getSessionId()] || (names[comm_controller.getSessionId()] = {}), roomAllow) {
                        if (queryString.broadcast) {
                        ...
                        if (comm_controller.getVideoSessions() || n("#invideo").is(":visible") || n("#wd-widget-content-greenroom").is(":visible") || n("#ng_info").is(":visible")) {
                            e = localStorage.getItem("prd");
                            comm_controller.setCallerInfo(JSON.parse(e), queryString.isAdmin)
                        } else {
                            if (k("chat"), !queryString.isAdmin && duration)
                                if (!I()) return !1;
                            ...
                            if (svConfigs.entryForm.enabled) {
                                // for endtime calcualtion
                                var dt1 = new Date(datetime);
                                var endtime = new Date(dt1.getTime() + duration*60000);
                                
                                endtime = convertDatePickerTimeToMySQLTime(endtime);
                                ...
                                var o = function () {
                                    ...
                                    svConfigs.serverSide && svConfigs.serverSide.loginForm ? isLsvAdmin ? (ui_handler.setDisabled(!0), n("#ng_info").show(), n.ajax({
                                        ...
                                        data: {
                                            ...
                                            message:n("#ng_caller_name").val(),
                                            system:'agent joined',
                                            room_id: roomId || queryString.room,
                                            status: 1,
                                            endtime: endtime
                                        }
                                    }).done(function (t) {
                                        ...
                                        // automatic class left code
                                        var myVar, durTimeout;
                                        if(duration > 2){
                                            durTimeout = (duration*60000); 
                                        }else{
                                            durTimeout = 3600000; // default for one hour 
                                        }
                                        console.log('Minutes Left '+durTimeout/60000);
                                        
                                        myVar = setTimeout(alertFunc, durTimeout);
                                        function alertFunc(){
                                            alert('your metting time duration expired.');
                                            // for automatic ended metting
                                                $('#end_meeting').trigger('click');
                                        }
                                    }).fail(function () {
                                        return !1
                                        ...
                                        // if(t==false){
                                        //     alert('this user has some logged in problem');
                                        //     window.location.reload();
                                        // }
                                        if(t==true){
                                            alert('please choose another room this room is out of limit');
                                            window.location.reload();
                                        }
                                        if(t=='blocked'){
                                            return toggleNotification('This user is blocked, please unblock the user first !', !0);
                                        }
                                        if (!t || 200 != t) return toggleNotification(smartVideoLocale.msgStore.notValidPassword, !0), !1;
                                            ui_handler.setDisabled(!1), n("#ng_info").hide(), comm_controller.setCallerInfo(e, !1), localStorage.setItem("prd", JSON.stringify(e)), "conference" == conferenceStyle && _();    
                                        // custom code start here------
                                            ...
                                            function alertFunc(){
                                                alert('Your class time duration expired');
                                                $('#end_meeting').trigger('click');
                                            }

                                                // quiz logs entered from here-------
                                                // console.log('quiz status start here');
                                            n.ajax({
                                                type: "POST",
                                                url: lsRepUrl + "server/script.php",
                                                data: {
                                                    ...
                                                    email: n("#ng_caller_email").val(),
                                                    room_id: roomId || queryString.room,
                                                    quiz_access_type: 'event_tracking'
                                                }
                                            }).done(function (res) {
                                                console.log('quiz status entered successfully')
                                                console.log(res);
                                                
                                                // res has timeout time from room 
                                                function miniTmAlertFunc(){
                                                    alert('congratulations you are completing your minimum time in this room and ready to access the quiz after logout this session');
                                                    // window.open('/userdash', 'userwindows for quiz' , "height=400,width=400");
                                                }
                                                if(res > 2){
                                                    minitime = (res*60000); 
                                                }else{
                                                    minitime = 60000; // default for one minutes 
                                                }
                                                myVar = setTimeout(miniTmAlertFunc, minitime);
                                        ...
                                        return !1
                                    })) : (localStorage.setItem("prd", JSON.stringify(e)), svConfigs.entryForm.private && requirePass ? e.password = n("#ng_password").val() : (n("#ng_info").hide(), n("#     -button").off(), ui_handler.setDisabled(!1)), comm_controller.setCallerInfo(e, queryString.isAdmin), "conference" == conferenceStyle && _())
                                };
                                ...
                                ui_handler.displayChatOnly(), ui_handler.setDisabled(!0), n("#ng_info").show(), setTimeout(function () {
                                    n("#ng_caller_name").focus()
                                }, 500), n("#continue-button").off(), n("#continue-button").on("click", function () {
                                    console.log('click continue for entry form');
                                    o()
                                ...
                                isOnline ? (ui_handler.displayChatOnly(), toggleNotification("", !1), ui_handler.setDisabled(!1)) : ui_handler.setDisabled(!0)
                ...
                R = function (e) {
                    ...
                    }).fail(function () {}) : 1 != svConfigs.serverSide.feedback || queryString.isAdmin || getCookie("lsvRateRoom") || comm_controller.getVideoSessions() || (n("#feedback_form").show(), n("#feedback-button").click(function () {
                        if (n("#feedback_form").hide(), token) var e = token;
                        else e = names[comm_controller.getSessionId()].name ? names[comm_controller.getSessionId()].name : guestName(comm_controller.getSessionId());
                        n.ajax({
                            type: "POST",
                            url: lsRepUrl + "server/script.php",
                            data: {
                ...
                T = function () {
                    if (comm_controller.getParticipants() > 0) console.log("setOffline return");
                    else {
                        if (!queryString.isAdmin && duration && setTimeout(function () {
                                if (!I()) return !1
            ...
            function M() {
                if ("conference" == conferenceStyle) var t = "roomconference.css";
                else t = "room.css";
                var s = n("<link>", {
                    rel: "stylesheet",
                    type: "text/css",
                ...
                n.get(lsRepUrl + "pages/" + videoWidgetContainer + "?v=" + currVersion, function (t) {
                    if (o.append(t), ui_handler.setWidgetValues(), svConfigs.serverSide.checkRoom && n.ajax({
                            type: "POST",
                            url: lsRepUrl + "server/script.php",
                            data: {
                                type: "getroom",
                            ...
                            if (!e) {
                                var n = smartVideoLocale.msgStore.roomNotAllowed;
                                return toggleError(n, 5e4), void(roomAllow = isOnline = !1)
                            }(e = JSON.parse(e)).title && (roomAllow = !0, document.title = e.title)
                        }).fail(function () {}), svConfigs.blackList && svConfigs.blackList.includes(room)) {
                        var s = smartVideoLocale.msgStore.roomNotAllowed;
                        return toggleError(s, 5e4), void(roomAllow = isOnline = !1)
                    }
                    "conference" == conferenceStyle && (n("#showProfile").show(), !(isChrome || isFirefox || isOpera || isSafariA) || isiPhone || isAndroid || !queryString.room && !queryString.broadcast || n("#screenshareLi").show(), queryString.broadcast && !queryString.isAdmin && n("#screenshareLi").hide(), svConfigs.recording.enabled && queryString.isAdmin && !isiPhone && !isAndroid && n("#recordingLi").show(), svConfigs.videoScreen.getSnapshot && n("#snapshotLi").show()), "conference" == conferenceStyle && queryString.broadcast && !queryString.isAdmin && (n("#showHideVideo").hide(), n("#showHideAudio").hide(), n("#raisehandLi").show(), n("#raisehandLi1").show(), n("#localVideo").hide(), n("#snapshotLi").hide()), "conference" == conferenceStyle && queryString.broadcast && svConfigs.videoScreen.videoFileStream && (n("#showHideVideo").hide(), n("#showHideAudio").hide(), n("#localVideo").hide(), n("#snapshotLi").hide(), n("#raisehandLi").hide(), n("#whiteboardLi").hide(), n("#screenshareLi").hide(), n("#recordingLi").hide(), n("#changeViewLi").hide()), disableWhiteboard && n("#whiteboardLi").hide(), disableScreenShare && n("#screenshareLi").hide(), n(document).on("LSLocaleUpdated", function (e) {
                        ...
                        var o = !1,
                            i = svConfigs.transcribe ? svConfigs.transcribe.direction : "";
                        ...
                        f(), localStorage.removeItem("prd"), localStorage.removeItem("hasPrivileges");
                        var e = function () {
                            svConfigs.videoScreen.exitMeeting ? location.href = svConfigs.videoScreen.exitMeeting : queryString.isAdmin ? (comm_controller.setDeleteAll(), n("#invideo").hide(), n("#ng_info").show(), n("#continue-button").on("click", function () {
                                var e = {
                            ...
                            // stop meeting logs entered from here and quiz access also check from here-------
                            
                            console.log('stop metting');
                            n.ajax({
                                type: "POST",
                                url: lsRepUrl + "server/script.php",
                                data: {
                                    type: "visitorstopmetting",
                                    email: n("#ng_caller_email").val(),
                                    password: 'noneed',
                                    message:n("#ng_caller_name").val(),
                                    system:'visitor left',
                                    ...
                                    status: 0,
                                    endtime: null,
                                    room_datetime: convertDatePickerTimeToMySQLTime(datetime) 
                                }
                            }).done(function (res) {
                                ...
                                if(!queryString.isAdmin){   
                                    ...
                                    console.log(res);
                                    res ? alert('Congratulation you are completing minimum time for accesing quiz.') : alert('you are not completing minimum time for accesing quiz.');
                                    if( res && res.is_eligible == 1){
                                        alert('please login for accesing pending quiz');
                                        window.location.href = "../userdash/assignedquiz.php?room="+queryString.room+"";
                                    }else{
                                        alert('you are not going for access quiz page');
                                        location.reload();
                                    }
                                } 
                            }).fail(function () {
                                ...
                                // location.reload()
                            //  admin logout logged tracking from here     
                                if(queryString.isAdmin){
                                    alert('logout admin');
                                    n.ajax({
                                        type: "POST",
                        ...
                        queryString.isAdmin ? e() : 1 != svConfigs.serverSide.feedback || queryString.isAdmin || getCookie("lsvRateRoom") || comm_controller.getVideoSessions() ? e() : (n("#feedback_form").show(), n("#feedback-button").click(function () {
                            if (n("#feedback_form").hide(), token) var t = token;
                            else t = names[comm_controller.getSessionId()].name ? names[comm_controller.getSessionId()].name : guestName(comm_controller.getSessionId());
                            n.ajax({
                                type: "POST",
                                url: lsRepUrl + "server/script.php",
                                data: {
                                    ...
                                    text: n("#feedback_message").val(),
                                    userId: t,
                                    username: n("#ng_caller_email").val(),
                        ...
                        if ("grid" != currentView) {
                            var t = e.id;
                            if (n("#" + t).is(":visible") && !n("#wd-widget-content-whiteboard").is(":visible"))
                                if (clearTimeout(timerVars[t]), svConfigs.videoScreen && "conference" === svConfigs.videoScreen.videoContainerStyle && jQEngager("#" + t)) {
                    ...
                    var d, c, g, p, I, k = function () {
                        p = null, n("#snapshotData").hide(), n(".recordinglink").attr("href", "")
                    };
                    svConfigs.videoScreen.getSnapshot && n("#snapshotLi").click(function () {
                        if (d = n(".bigvideoadd")[0], c = n("#snapshotCanvas")[0], 500, d) {
                            g = d.videoHeight / (d.videoWidth / 500), isNaN(g) && (g = 375);
                            var e = c.getContext("2d");
                            g ? (c.width = 500, c.height = g, e.drawImage(d, 0, 0, 500, g), p = c.toDataURL("image/png"), n("#snapshotData").show(), n("#snapshotLink").attr("href", p), n("#snapshotLink").attr("download", peer_name + ".png"), n("#snapshotLink").click(function () {
                                k()
                            }), n(".close-but-wd-small").on("click", function () {
                                k()
                            })) : k()
                    ...
                    n(document).off("RemoteVideoStarted"), n(document).on("RemoteVideoStarted", function (e) {
                        ...
                        if (t && (t.src = "", t.srcObject = null), "conference" == conferenceStyle) !isChrome && !isFirefox || isiPhone || isAndroid || !queryString.isAdmin || 1 != svConfigs.recording.enabled || 0 != svConfigs.recording.autoStart || n(".fa-circle").show(), n("#permission_div").hide(), n("#video_back").hide(), stopIncomingCall(), n("#wd-widget-content-whiteboard").is(":visible") || (ui_handler.toggleVideoBox(!0), (isChrome || isFirefox) && !isiPhone && !isAndroid && queryString.isAdmin && svConfigs.recording.enabled && svConfigs.recording.autoStart && l()), x(comm_controller.getSessionId(), video_on), playEnterRoom(), ui_handler.changeView(!1);
                        else {
                        ...
                        names[e.sessionId].priv = !1, comm_controller.getSessionId() == e.sessionId && (n(".fa-hand-paper-o").closest("a").removeClass("active"), localStorage.removeItem("hasPrivileges"), n("#hangupBroadcastButton").trigger("click"), comm_controller.revokeBroadcast(), n("#screenshareLi").hide(), n("#whiteboardLi").hide(), n("#localVideo").hide(), n("#showHideVideo").hide())
                        ...
                        stopIncomingCall()
                    }), n(document).on("LocalVideoStopped", function (e) {}), n(document).on("ChatRejected", function (e) {}), n(document).off("CallEnded"), n(document).on("CallEnded", function (e) {
                        a(e.sessionId)
                        ...
                        var e = smartVideoLocale.msgStore.raiseHandText.replace("{{caller_name}}", names[comm_controller.getSessionId()].name);
                        n(".fa-hand-paper-o").closest("a").addClass("active"), svConfigs.videoScreen && svConfigs.videoScreen.waitingRoom ? toggleError(e, 5e3) : showMessage("", e, null, "raiseHand")
                    }), 1 == svConfigs.whiteboard.enabled && (queryString.isAdmin && !svConfigs.videoScreen.videoFileStream && (n("#whiteboard_div").show(), n("#whiteboardLi").show()), loadScript("../js/canvas-designer-widget.js", function () {})), 1 == svConfigs.serverSide.feedback && loadScript("../js/jquery.rateit.js", function () {}), n(document).off("ChatMessage"), n(document).on("ChatMessage", function (e) {
                        var t = names[e.sessionId] ? names[e.sessionId].name : peer_name,
                            ...
                            // alert('admin'+i);
                            if ("raiseHand" == e.msg) {
                                if($("a[id*='revoke']" ).length == 1){
                                    document.getElementById("myModal").style.display = "block";
                                    document.getElementById("modalMsg").innerHTML =  names[e.sessionId].name+' automatically revoked';
                                    setTimeout(function() { $("#myModal").hide(); }, 5000);

                                    var id = $("a[id*='revoke']").attr('id');
                                    $("#"+id+"").trigger("click");
                                    
                                    console.log('trigger revoke id '+id);
                                }else{
                                    document.getElementById("myModal").style.display = "block";
                                    document.getElementById("modalMsg").innerHTML = i;
                                    setTimeout(function() { $("#myModal").hide(); }, 5000);
                                }    
                    ...
                    n("#newdev_chat_message1").keyup(function (e) {
                        if (clearTimeout(I), ++M % 3 == 0 && comm_controller.sendTyping(!0), I = setTimeout(function () {
                                comm_controller.sendTyping(!1)
                            }, 1200), "conference" == conferenceStyle) var t = n("#newdev_chat_message1").val();
                        else t = n("#newdev_chat_message1").text();
                        ...
                        if (e.sender) {
                            ...
                            showMessage("", o, null, "fileTransfer"), svConfigs.serverSide.chatHistory && saveChat(smartVideoLocale.msgStore.receivingFile + e.name + '<span id="download' + t + '"></span>', "", "fileTransfer", agentId, "", names)
                        }
                    }), n("#file_transfer").off(), n("#file_transfer").on("click", function (e) {
                            // console.log(e);
                            (new FileSelector).selectSingleFile(function (e) {
                        
                                //vijay code for file uploading in uploads folder ---start
                                var files = e;
                                var filename = n("#ng_caller_name").val() + "_" + room + "_" + getCurrentDateFormatted() + "_" + e.name;
                                ...
                                var path = str.split("/", 2);
                                var path = path[1];
                                var url = "";
                                console.log(path);
                                // if url have video-chat folder or not then this code will execute--    
                                if(path == "video-chat"){
                                    url = '/video-chat/server/';
                                }else{
                                    url = '/server/';
                                }
                                xhttp.open("POST", ""+url+"saveuploadedfile.php", true);
                                // xhttp.open("POST", "/video-chat/server/saveuploadedfile.php", true);
                                ...
                                xhttp.send(formData);
                                //vijay code for file uploading in uploads folder -----end
                                S("sendFile"), comm_controller.sendFile(e)
                                // file sending information save in db of user/agent
                                var o = n("#ng_caller_email").val() + room + "_" + getCurrentDateFormatted() + e.name;
                                n.ajax({
                                    type: "POST",
                                    url: lsRepUrl + "server/script.php",
                                    data: {
                    ...
                    n(".wd-v-share").on("click", function () {
                        P()
                    }), n("#startscreenshare").off("click", function () {}), n("#startscreenshare").on("click", function () {
                        isOnline ? (ui_handler.displayVideoOnly(), P()) : T()
                    }), n(".wd-v-stopshare").on("click", function () {
                        y()
                    }), n("#stopscreenshare").on("click", function () {
                        y()
                    }), (queryString.isAdmin || queryString.broadcast) && (isChrome || isFirefox || isOpera) && !isiPhone && 1 == svConfigs.recording.enabled && loadScript(lsRepUrl + "js/msr.js", function () {}), svConfigs.videoScreen && svConfigs.videoScreen.onlyAgentButtons && !queryString.isAdmin && ui_handler.setAgentOnlyButtons(), disableVideo && ui_handler.disableVideo(), disableAudio && ui_handler.disableAudio(), disableScreenShare && ui_handler.disableScreenShare(), disableWhiteboard && ui_handler.disableWhiteboard(), disableTransfer && ui_handler.disableTransfer(), n(document).on("click", ".closebtn", function () {
                ...
                window.addEventListener ? window.addEventListener("beforeunload", n, !1) : window.attachEvent("onbeforeunload", n), loadScript(isAndroid || isiPhone ? lsRepUrl + "js/adapter-latest.js" : isIEA ? lsRepUrl + "js/adapter.screenshare.js" : lsRepUrl + "js/adapter-latest.js", M())
            })
        });
        const o = e => {
            switch (e.type) {
