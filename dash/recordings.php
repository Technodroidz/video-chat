...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left" data-localize="categoryRecordings">Category <?php echo $_GET['category']; ?> Recordings</h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered" id="recordings_table" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" data-localize="agent">Quiz Category</th>
