...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" data-localize="quiz_list">Essay Type Quiz User Questions List</h6>
            ...
            <table class="table table-bordered" id="chats_table" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" data-localize="question">Question</th>
                        <th class="text-center" data-localize="totalMarks">Total Marks</th>
                        <th class="text-center" data-localize="score">Score</th>
