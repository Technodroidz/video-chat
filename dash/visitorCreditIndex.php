                ...
                <table class="table table-bordered" id="users_table" width="100%" cellspacing="0">
                    <thead>
                        ...
                        <th class="text-center" data-localize="chat_id">S.no</th>
                            ...
                            <th class="text-center" data-localize="minimumScore">Minimum Score</th>
                            ...
                            <th class="text-center" data-localize="creditAssignStatus">Credit assigned</th>
                            <th class="text-center" data-localize="usercredits">User Credits Roomwise</th>
