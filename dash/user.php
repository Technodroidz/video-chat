        ...
        <div class="col-lg-5">
            <div class="p-1">
                ...
                <form class="user">
                    ...
                    <div class="form-group">
                        <label for="credits"><h6 data-localize="credits">Credits</h6></label>
                        <input type="text" class="form-control " id="credits" aria-describedby="credits">
                    </div>

                    <div class="form-group">
                        <label for="minimum_credit_score"><h6 data-localize="minimum_credit_score">Minimum Credit Score</h6></label>
                        <input type="text" class="form-control " id="minimum_credit_score" aria-describedby="minimum_credit_score">
                    </div>
