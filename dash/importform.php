...
<body>
<h1 class="h3 mb-2 text-gray-800" id="userTitle" data-localize="uploadform">Import Users</h1>
    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            <div class="float-right" style="margin-right:20px;">
                ...
                <a href="../server/downloads/users_sample_list.csv" download data-localize="download" target="_blank" title="Please download sample file for importing format">Download Sample CSV
            ...
            <div class="card-body">
                <div class="row">
                    <div class="page-container row-12">
                        <h4 class="col-12 text-center mb-5">Create Users By Importing Users List File </h4>
