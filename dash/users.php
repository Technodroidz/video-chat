...
<?php if ($_SESSION["tenant"] == 'lsv_mastertenant') { ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="float-right" style="margin-right:20px;"><a href="importform.php" class=""><i class="fas fa-upload fa-2x text-300" title="Click here for importing users list in .csv format"></i></a></div>
        </div>
        <div class="card-body">
