...
<?php if ($_SESSION["tenant"] != 'user') { ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary float-left" data-localize="usersbyrooms">Users Hours By Room Details</h6>
                ...
                <table class="table table-bordered" id="users_table" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" data-localize="roomInOut">Room In/Out count</th>
