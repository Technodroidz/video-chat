...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left" data-localize="watched_videos_tracking">Videos Tracking Report By Videos</h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered" id="recordings_table" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" data-localize="totalWatchedTime">Total watched Time</th>
